...
#### Converting QE files to PANNA json
...
We will now convert the information to a fixed size representation of the local atomic environment that can be understood by the network,
